//Eyad Kathir
//Airplane seating reservation program
//User will be able to pick a seat(s) based on the available ones
//User can press Q or q at any time to quit the program
...
public class AirplaneSeating {
    ...
    public static void main(String[] args) {
        ...
        while (filled < 38 && seatNumber.length() > 0) {
    ...
    private static void printSeats(char[][] seats) {
        ...
        int numberOfSeatsAvailable = (38 - filled);
